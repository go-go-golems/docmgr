...
- [ ] Read 005 diary + 004 analysis so you know what changed and why
...
- [ ] Update docs: document --ticket for skill show, ticket printing in list/show, and active-ticket-only default behavior
- [ ] Add a guideline/template for DocType=skill so doc add --doc-type skill has good scaffolding (and avoids 'No guidelines found')
- [ ] Decide/confirm convention: ticket skills live under /skill/ (doc-type folder) vs /skills/ (docs mention both); update docs accordingly
