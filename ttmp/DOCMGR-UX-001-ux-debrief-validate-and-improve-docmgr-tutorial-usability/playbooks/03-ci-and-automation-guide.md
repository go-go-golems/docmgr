...
RelatedFiles:
    - path: playbooks/02-setup-tutorial-v2-restructured.md
      note: Setup tutorial (extracted CI content from here)
ExternalSources: []
Summary: "CI/CD integration guide for docmgr: GitHub Actions, GitLab, pre-commit hooks, Makefile, reporting"
LastUpdated: 2025-11-06
---

# CI and Automation Guide for docmgr

**Enforce documentation quality automatically with CI/CD integration.**

## Overview

This guide shows how to integrate docmgr validation into your CI/CD pipeline. You'll set up:
...
**Prerequisites:**
- docmgr already initialized in your repository (`docmgr init`)
- CI/CD system configured (GitHub Actions, GitLab CI, etc.)
