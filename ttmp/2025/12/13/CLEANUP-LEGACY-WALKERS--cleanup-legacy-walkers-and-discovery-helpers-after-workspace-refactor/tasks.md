...
- [x] [7] Migrate `tasks.go` ticket discovery to QueryDocs — Replace `findTicketDirectory` fallback. See: design/01-cleanup-overview-and-migration-guide.md §5 Phase 2.3
...
- [x] [21] Run integration test suite after Phase 3
- [x] [22] Final integration test suite after Phase 4
- [x] [23] Manual smoke tests for all migrated commands
