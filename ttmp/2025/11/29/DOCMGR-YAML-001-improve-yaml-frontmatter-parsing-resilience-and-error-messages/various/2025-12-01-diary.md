...
- Added afterthoughts (later in day): polished auto-fix to suppress error taxonomy on success and re-emit fresh taxonomy only on failed re-parse; added unit tests for fix heuristics (delimiter normalization, stray delimiter cleanup); reran smokes (00–03, 15, 18).
