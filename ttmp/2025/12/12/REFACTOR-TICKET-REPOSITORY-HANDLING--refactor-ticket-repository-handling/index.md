...
RelatedFiles:
    ...
    - Path: ttmp/2025/12/12/REFACTOR-TICKET-REPOSITORY-HANDLING--refactor-ticket-repository-handling/playbook/03-playbook-how-to-run-a-code-talent-show-end-to-end.md
      Note: End-to-end talent show operating procedure
