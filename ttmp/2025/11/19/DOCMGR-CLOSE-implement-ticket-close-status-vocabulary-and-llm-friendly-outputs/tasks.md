...
- [x] Document suggested status transitions (not enforced) in help/docs
...
- [x] Update docs: how-to-use + cli-guide to include 'ticket close' + structured output guidance
